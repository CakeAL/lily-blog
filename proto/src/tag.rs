...
pub struct CreateTagServiceRequest {
    #[prost(string, tag = "1")]
    pub name: ::prost::alloc::string::String,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct CreateTagServiceReply {
    #[prost(int32, tag = "1")]
    pub id: i32,
}
...
pub mod tag_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn create_tag_service(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateTagServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateTagServiceReply>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/tag.TagService/CreateTagService",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("tag.TagService", "CreateTagService"));
...
pub mod tag_service_server {
    ...
    pub trait TagService: Send + Sync + 'static {
        /// 创建 Tag
        async fn create_tag_service(
            &self,
            request: tonic::Request<super::CreateTagServiceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CreateTagServiceReply>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/tag.TagService/CreateTagService" => {
                    ...
                    struct CreateTagServiceSvc<T: TagService>(pub Arc<T>);
                    impl<
                        T: TagService,
                    > tonic::server::UnaryService<super::CreateTagServiceRequest>
                    for CreateTagServiceSvc<T> {
                        type Response = super::CreateTagServiceReply;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as TagService>::create_tag_service(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = CreateTagServiceSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
